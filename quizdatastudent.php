    ...
    tcquiz_send_error(get_string('badquizid', 'tcquiz').$quizid);
      ...
      switch ($status) {
          ...
          case TCQUIZ_STATUS_SHOWQUESTION: // Question being displayed.
              ...
              echo '<url>';
              echo new moodle_url('/mod/quiz/accessrule/tcquiz/attempt.php',['page' => $tcquiz->currentpage, 'showall' => false, 'attempt' => $attempt, 'quizid' => $quizid, 'cmid' => $cmid, 'sessionid' => $tcquiz->id ]);
              echo '</url>';
