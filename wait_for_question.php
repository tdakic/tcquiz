...
echo $output->render_from_template('quizaccess_tcquiz/wait_for_question', ['sessionid'=>$session->id, 'joincode'=>$joincode, 'quizid'=>$quizid, 'cmid'=>$cmid, 'attemptid'=>$attemptid]);
