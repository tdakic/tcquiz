...
echo $output->render_from_template('quizaccess_tcquiz/wait_for_students', ['sessionid'=>$session->id, 'joincode'=>$joincode, 'quizid'=>$quizid, 'cmid'=>$cmid, 'attemptid'=>$attemptid]);
